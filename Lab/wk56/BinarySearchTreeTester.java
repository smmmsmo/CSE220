...
public class BinarySearchTreeTester {
    ...
    public static void main(String[] args) {
        ...
        if (input.equals("5") || input.equals(""))
            task5();
        if (input.equals("6") || input.equals(""))
            task6();
    ...
    public static void task2() {
        ...
        if (out != null && exp.equals(out.trim()))
            successPrint("Task#2 Test1");
        else
            failedPrint("Task#2 Test1");
        ...
        System.out.print(normal);
        if (out != null && exp.equals(out.trim()))
            successPrint("Task#2 Test2");
        else
            failedPrint("Task#2 Test2");
    }
    ...
    public static void task6() {
        ...
        System.out.println(out);
        System.out.print(normal);
        if (out != null && exp.equals(out))
            successPrint("Task#6 Test1");
        else
            failedPrint("Task#6 Test1");
        ...
        System.out.print(normal);
        if (out != null && exp.equals(out))
            successPrint("Task#6 Test2");
        else
            failedPrint("Task#6 Test2");
    }
